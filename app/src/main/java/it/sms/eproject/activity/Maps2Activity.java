...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mOrigin = getLocationFromAddress(getApplicationContext(), "via Dante, 1, 70023 Gioia del Colle BA");
        mDestination = getLocationFromAddress(getApplicationContext(), "via Michele Petrera, 42, 70023 Gioia del Colle BA");
        ...
        mDestination = getLocationFromAddress(getApplicationContext(), "Via Piottola, 12, 70023 Gioia del Colle BA");
